...
public class FileNames {
	...
	public static final String KORISNICI_FILE = "korisnici.txt";
	public static final String ORGANIZACIJE_FILE = "organizacije.txt";
	public static final String MASINE_FILE = "masine.txt";
